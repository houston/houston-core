# The Intercom gem auto-includes the Intercom script tag
# everywhere. We want to include it manually in certain
# layouts and leave it off of others (e.g. emails, dashboards)
ActionController::Base.skip_after_filter :intercom_rails_auto_include

if Houston.config.use_intercom?
  IntercomRails.config do |config|
    # == Intercom app_id
    #
    config.app_id = Houston.config.intercom[:app_id]
