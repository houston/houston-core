  ...
  test "#fetch_results! should correctly parse Jenkins build data" do
    ...
    expected_results = {
      ...
      tests:        [{
        ...
        status: :error, duration: 1.9763, age: 13,
        error_message: "undefined method `git_dir' for #<Houston::VersionControl::NullRepoClass:0xa176470> (NoMethodError)",
