module MilestoneSynchronizer
  ...
  def fetch_all
    Skylight.instrument title: "GET All Milestones" do
      synchronize ticket_tracker.all_milestones
    end
  end
  
  def fetch_open
    Skylight.instrument title: "GET Open Milestones" do
  ...
  def synchronize(unsynchronized_milestones)
    ...
    Project.benchmark("[milestones.synchronize] synchronizing with local milestones") do
      Skylight.instrument title: "Synchronize Milestones" do
